...
def main():
    ...
    #                     pre_run2 = False
    #                     """
    #                     Mode = input("What mode do you want to play?\nEnter\t1 for easy mode\n\t2 for Normal mode\n\t3 for Hard mode\n")
    #                     if int(Mode) == 1:
    #                         ChessAI.DEPTH = 1
    #                         print(ChessAI.DEPTH)
    #                         break
    ...
    if (player[0] == False and  player[1] == False):
        running = False
    ...
    while running:
        human_turn = (game_state.white_to_move and player[0]) or (not game_state.white_to_move and player[1])
